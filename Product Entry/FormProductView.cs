...
namespace Product_Entry
{
    public partial class FormProductView : Form
    {
        ...
        private void FormProductView_Load_1(object sender, EventArgs e)
        {
            lst.AddRange(new[] {
        ...
        {
            FormAddEdit frmAdd = new FormAddEdit("Adding Products", FormAddEdit.Operation.OP_ADD, bs);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            FormAddEdit frmEdit = new FormAddEdit("Editing Product", FormAddEdit.Operation.OP_EDIT, bs);
            frmEdit.Show();
        }     
    }
}
